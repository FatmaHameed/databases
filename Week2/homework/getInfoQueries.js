...
const authorCollaborator = "SELECT A1.author_name AS author, \
...
If there is an author without any Research_Papers, 
print the information of that Author too.*/

const authorPaper = "SELECT A.author_name Author, \
P.paper_title Research_title \
FROM auth_res R JOIN research_papers P \
